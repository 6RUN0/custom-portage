...
# $Header: /usr/local/portage/app-emulation/virtinst/virtinst-0.600.4-p1.ebuild,v 1.1 2014/03/01 11:16:37 root Exp root $
...
SLOT="0"
IUSE=""
RDEPEND="|| ( >=app-emulation/libvirt-0.7.0[python] >=dev-python/libvirt-python-1.2.0 )
